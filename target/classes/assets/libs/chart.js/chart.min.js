 ...
 */
    ...
    function Be(t, e, i, s) {
        const n = e._rootScopes, o = Ie(e._fallback, i, s), a = [...t, ...n], r = new Set;
        r.add(s);
    ...
    const je = Number.EPSILON || 1e-14, $e = (t, e) => e < t.length && !t[e].skip && t[e],
        Ye = t => "x" === t ? "y" : "x";
    ...
    function Xe(t, e = "x") {
        const i = Ye(e), s = t.length, n = Array(s).fill(0), o = Array(s);
        let a, r, l, h = $e(t, 0);
    ...
    function Ke(t, e, i, s, n) {
        let o, a, r, l;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) Xe(t, n); else {
    ...
    const Ge = t => 0 === t || 1 === t, Ze = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * At / i),
        Je = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * At / i) + 1, Qe = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
    ...
    function ii(t, e, i, s) {
        const n = {x: t.cp2x, y: t.cp2y}, o = {x: e.cp1x, y: e.cp1y}, a = ti(t, n, i), r = ti(n, o, i), l = ti(o, e, i),
            h = ti(a, r, i), c = ti(r, l, i);
        return ti(h, c, i)
    }
    ...
    function vi(t, e, i) {
        ...
        const {property: s, start: n, end: o} = i, a = e.length, {
            ...
            between: l,
            normalize: h
        } = _i(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
        ...
        return null !== _ && g.push(yi({start: _, end: d, loop: u, count: a, style: f})), g
    }
    ...
    function ki(t, e, i, s) {
        return s && s.setContext && i ? function (t, e, i, s) {
            const n = t._chart.getContext(), o = Si(t.options), {_datasetIndex: a, options: {spanGaps: r}} = t,
                l = i.length, h = [];
    ...
    function Oi(t, e, i, s, n) {
        ...
        for (let t = 0, i = o.length; t < i; ++t) {
            const {index: i, data: r} = o[t], {lo: l, hi: h} = Ci(o[t], e, a, n);
            for (let t = l; t <= h; ++t) {
                const e = r[t];
                e.skip || s(e, i, t)
            }
    ...
    function Ai(t, e, i, s, n) {
        ...
        return Oi(t, i, e, (function (i, a, r) {
            (n || ve(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({element: i, datasetIndex: a, index: r})
        }), !0), o
    }
    ...
    var Ei = {
        evaluateInteractionItems: Oi, modes: {
            index(t, e, i, s) {
                const n = he(e, t), o = i.axis || "x", a = i.includeInvisible || !1,
                    r = i.intersect ? Ai(t, n, o, s, a) : Li(t, n, o, !1, s, a), l = [];
    ...
    var Xi = {
        addBox(t, e) {
            ...
            if (!t) return;
            const n = di(t.options.layout.padding), o = Math.max(e - n.width, 0), a = Math.max(i - n.height, 0),
                r = function (t) {
                    const e = function (t) {
                            const e = [];
                            let i, s, n, o, a, r;
                            ...
                            return e
                        }(t), i = Bi(e.filter((t => t.box.fullSize)), !0), s = Bi(zi(e, "left"), !0),
                        n = Bi(zi(e, "right")), o = Bi(zi(e, "top"), !0), a = Bi(zi(e, "bottom")), r = Fi(e, "x"),
                        l = Fi(e, "y");
                    return {
                        fullSize: i,
            ...
            Wi(u, di(s));
            const f = Object.assign({maxPadding: u, w: o, h: a, x: n.left, y: n.top}, n), g = Vi(l.concat(h), d);
    ...
    class hs extends qi {
        ...
        addEventListener(t, e, i) {
            ...
            const s = t.$proxies || (t.$proxies = {}), n = {attach: es, detach: is, resize: as}[e] || ls;
            s[e] = n(t, e, i)
        }
        ...
        removeEventListener(t, e) {
            ...
            if (!s) return;
            ({attach: rs, detach: rs, resize: rs}[e] || Qi)(t, e, s), i[e] = void 0
        }
    ...
    class Cs {
        ...
        linkScales() {
            const t = this.chart, e = this._cachedMeta, i = this.getDataset(),
                s = (t, e, i, s) => "x" === t ? e : "r" === t ? s : i, n = e.xAxisID = Z(i.xAxisID, ks(t, "x")),
                o = e.yAxisID = Z(i.yAxisID, ks(t, "y")), a = e.rAxisID = Z(i.rAxisID, ks(t, "r")), r = e.indexAxis,
        ...
        applyStack(t, e, i) {
            ...
            return _s({keys: xs(s, !0), values: e._stacks[t.axis]}, o, n.index, {mode: i})
        }
        ...
        getMinMax(t, e) {
            const i = this._cachedMeta, s = i._parsed, n = i._sorted && t === i.iScale, o = s.length,
                ...
                r = ((t, e, i) => t && !e.hidden && e._stacked && {keys: xs(i, !0), values: null})(e, i, this.chart),
    ...
    class Ns extends Os {
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: o} = s, a = n.offset,
                r = this.isHorizontal(), l = this.ticks.length + (a ? 1 : 0), h = Fs(n), c = [],
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: n} = i, o = this.isHorizontal(),
                a = this.ticks, {align: r, crossAlign: l, padding: h, mirror: c} = n, d = Fs(i.grid), u = d + h,
        ...
        drawTitle() {
            ...
            if (!i.display) return;
            const o = ui(i.font), a = di(i.padding), r = i.align;
        ...
        _createDescriptors(t, e) {
            ...
            return !1 !== s || e ? function (t, e, i, s) {
                ...
                for (let a = 0; a < e.length; a++) {
                    ...
                    null !== l && n.push({plugin: r, options: Ys(t.config, r, l, o)})
                }
                return n
            }(t, n, s, e) : []
        }
    ...
    function qs(t) {
        ...
        e.plugins = Z(e.plugins, {}), e.scales = function (t, e) {
            const i = mt[t.type] || {scales: {}}, s = e.scales || {}, n = Us(t.type, e), o = Object.create(null),
            ...
            return Object.keys(s).forEach((t => {
                ...
                const r = Xs(t, e), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, n), h = i.scales || {};
                o[r] = o[r] || t, a[t] = rt(Object.create(null), [{axis: r}, e, h[r], h[l]])
            })), t.data.datasets.forEach((i => {
                const n = i.type || t.type, r = i.indexAxis || Us(n, e), l = (mt[n] || {}).scales || {};
    ...
    class tn {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            const n = {$shared: !0}, {resolver: o, subPrefixes: a} = en(this._resolverCache, t, s);
            let r = o;
            if (function (t, e) {
    ...
    function en(t, e, i) {
        ...
        let o = s.get(n);
        if (!o) {
            o = {resolver: Oe(e, i), subPrefixes: i.filter((t => !t.toLowerCase().includes("hover")))}, s.set(n, o)
        }
        return o
    }
    ...
    class fn {
        constructor(t, e) {
            const s = this.config = new tn(e), n = hn(t), o = dn(n);
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                const i = e[t], s = Xs(t, i), n = "r" === s, o = "x" === s;
                return {
                    options: i,
        ...
        update(t) {
            ...
            o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || et(n, (t => {
                t.reset()
            })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", {mode: t}), this._layers.sort(an("z", "_idx"));
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {cancelable: !0}) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), rn({chart: this})))
        }
    ...
    class Dn extends Cs {
        ...
        updateElements(t, e, i, s) {
            ...
            for (let c = e; c < e + i; c++) {
                const e = this.getParsed(c),
                    i = n || U(e[a.axis]) ? {base: r, head: r} : this._calculateBarValuePixels(c),
        ...
        _calculateBarValuePixels(t) {
            const {_cachedMeta: {vScale: e, _stacked: i}, options: {base: s, minBarLength: n}} = this, o = s || 0,
                a = this.getParsed(t), r = a._custom, l = wn(r);
    ...
    class An extends Cs {
        ...
        updateElements(t, e, i, s) {
            const n = "reset" === s, {iScale: o, vScale: a, _stacked: r, _dataset: l} = this._cachedMeta,
                ...
                m = Wt(g) ? g : Number.POSITIVE_INFINITY, b = this.chart._animationsDisabled || n || "none" === s;
            let x = e > 0 && this.getParsed(e - 1);
            for (let h = e; h < e + i; ++h) {
                const e = t[h], i = this.getParsed(h), g = b ? e : {}, _ = U(i[f]),
    ...
    An.id = "line", An.defaults = {
        ...
        showLine: !0,
        spanGaps: !1
    }, An.overrides = {scales: {_index_: {type: "category"}, _value_: {type: "linear"}}};
    ...
    Ln.id = "pie", Ln.defaults = {cutout: 0, rotation: 0, circumference: 360, radius: "100%"};
    ...
    En.id = "scatter", En.defaults = {showLine: !1, fill: !1}, En.overrides = {
    ...
    function Vn(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / Ot) / c) / 2, p = r + g + u, m = n - g - u, {
                ...
                innerStart: _,
                innerEnd: y
            } = Fn(e, d, c, m - p), v = c - b, w = c - x, M = p + b / v, k = m - x / w, S = d + _, P = d + y, D = p + _ / S,
            C = m - y / P;
    ...
    }, Gn.descriptors = {_scriptable: !0, _indexable: t => "borderDash" !== t && "fill" !== t};
    ...
    function eo(t) {
        const e = Qn(t), i = e.right - e.left, s = e.bottom - e.top, n = function (t, e, i) {
            ...
            const {enableBorderRadius: s} = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = ci(n),
    ...
    oo.id = "bar", oo.defaults = {
        ...
        inflateAmount: "auto",
        pointStyle: void 0
    }, oo.defaultRoutes = {backgroundColor: "backgroundColor", borderColor: "borderColor"};
    var ao = Object.freeze({__proto__: null, ArcElement: Wn, LineElement: Gn, PointElement: Jn, BarElement: oo});
    ...
    function go(t, e) {
        ...
        }(t, e), i.length ? new Gn({points: i, options: {tension: 0}, _loop: s, _fullLoop: s}) : null
    }
        ...
        const n = function (t) {
            if ((t.scale || {}).getPointPositionForValue) return function (t) {
                ...
                if (s.grid.circular) {
                    ...
                    return new _o({x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(a)})
                }
    ...
    function vo(t, e, i) {
        const s = yo(e), {line: n, scale: o, axis: a} = e, r = n.options, l = r.fill,
        ...
        s && n.points.length && (we(t, i), function (t, e) {
            ...
            Mo(t, {line: i, target: s, color: o, scale: r, property: l}), t.restore()
        }(t, {line: n, target: s, above: c, below: d, area: i, scale: o, axis: a}), Me(t))
    }
    ...
    function Mo(t, e) {
        const {line: i, target: s, property: n, color: o, scale: a} = e, r = function (t, e, i) {
            ...
            for (const t of s) {
                ...
                const h = wi(e, l);
                for (const e of h) {
                    const s = co(i, o[e.start], o[e.end], e.loop), r = vi(t, n, s);
    ...
    class Co extends Os {
        ...
        fit() {
            ...
            const i = t.labels, s = ui(i.font), n = s.size, o = this._computeTitleHeight(), {
                boxWidth: a,
                itemHeight: r
            } = Do(i, n);
            let l, h;
        ...
        adjustHitBoxes() {
            ...
            } = this, a = mi(o, this.left, this.width);
            if (this.isHorizontal()) {
        ...
        _draw() {
            const {options: t, columnSizes: e, lineWidths: i, ctx: s} = this, {align: a, labels: r} = t, l = yt.color,
                h = mi(t.rtl, this.left, this.width), c = ui(r.font), {color: d, padding: u} = r, f = c.size, g = f / 2;
            let p;
            this.drawTitle(), s.textAlign = h.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = c.string;
            const {boxWidth: m, boxHeight: b, itemHeight: x} = Do(r, f), _ = this.isHorizontal(),
            ...
            this.legendItems.forEach(((w, M) => {
                ...
                !function (t, e, i) {
                    ...
                    if (s.fillStyle = Z(i.fillStyle, l), s.lineCap = Z(i.lineCap, "butt"), s.lineDashOffset = Z(i.lineDashOffset, 0), s.lineJoin = Z(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = Z(i.strokeStyle, l), s.setLineDash(Z(i.lineDash, [])), r.usePointStyle) {
                        ...
                        const o = e + Math.max((f - b) / 2, 0), a = h.leftForLtr(t, m), r = ci(i.borderRadius);
                    ...
                    Pe(s, i.text, t, e + x / 2, c, {strikethrough: i.hidden, textAlign: h.textAlign(i.textAlign)})
                }(h.x(D), C, w), _ ? p.x += P + u : p.y += v
            })), xi(this.ctx, t.textDirection)
        }

        drawTitle() {
            const t = this.options, e = t.title, i = ui(e.font), o = di(e.padding);
            if (!e.display) return;
            const a = mi(t.rtl, this.left, this.width), r = this.ctx, l = e.position, h = i.size / 2, c = o.top + h;
    ...
    class Ao extends Os {
        ...
        draw() {
            ...
            if (!e.display) return;
            const i = ui(e.font), n = i.lineHeight / 2 + this._padding.top, {
                titleX: o,
                titleY: a,
                maxWidth: r,
                rotation: l
    ...
    function Bo(t, e) {
        const i = t.chart.ctx, {body: s, footer: n, title: o} = t, {boxWidth: a, boxHeight: r} = e, l = ui(e.bodyFont),
            h = ui(e.titleFont), c = ui(e.footerFont), d = o.length, u = n.length, f = s.length, g = di(e.padding);
    ...
    class Yo extends Os {
        ...
        _resolveAnimations() {
            ...
            const e = this.chart, i = this.options.setContext(this.getContext()),
                s = i.enabled && e.options.animation && i.animations, n = new ms(this.chart, s);
        ...
        getBody(t, e) {
            ...
            return et(t, (t => {
                const e = {before: [], lines: [], after: []}, n = $o(i, t);
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Bo(this, i), a = Object.assign({}, t, e), r = No(this.chart, i, a),
        ...
        getCaretPosition(t, e, i) {
            const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {
                ...
                bottomLeft: h,
                bottomRight: c
            } = ci(a), {x: d, y: u} = t, {width: f, height: g} = e;
            let p, m, b, x, _, y;
        ...
        _drawColorBox(t, e, i, s, n) {
            const o = this.labelColors[i], a = this.labelPointStyles[i], {boxHeight: r, boxWidth: l, boxPadding: h} = n,
                c = ui(n.bodyFont), d = Ho(this, "left", n), u = s.x(d),
        ...
        drawBody(t, e, i) {
            ...
            const f = mi(i.rtl, this.x, this.width), g = function (i) {
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                if (!i) return;
                const o = this._size = Bo(this, t), a = Object.assign({}, i, this._size), r = No(e, t, a),
                    l = Wo(t, a, r, e);
    ...
    class Zo extends Ns {
        ...
        buildTicks() {
            ...
            const s = function (t, e) {
                ...
                let P = 0;
                for (m && (d && v !== o ? (i.push({value: o}), v < o && P++, Ht(Math.round((v + P * k) * y) / y, o, Go(o, _, t)) && P++) : v < o && P++); P < M; ++P) i.push({value: Math.round((v + P * k) * y) / y});
                return b && d && w !== a ? i.length && Ht(i[i.length - 1].value, a, Go(a, _, t)) ? i[i.length - 1].value = a : i.push({value: a}) : b && w !== a || i.push({value: w}), i
            }({
                maxTicks: i,
                bounds: t.bounds,
                min: t.min,
    ...
    Jo.id = "linear", Jo.defaults = {ticks: {callback: Ts.formatters.numeric}};
    ...
    function sa(t) {
        ...
        for (let d = 0; d < o; d++) {
            ...
            n[d] = o.padding;
            const u = t.getPointPosition(d, t.drawingArea + n[d], r), f = ui(o.font),
    ...
    ta.id = "logarithmic", ta.defaults = {ticks: {callback: Ts.formatters.logarithmic, major: {enabled: !0}}};
    ...
    class ha extends Zo {
        ...
        setDimensions() {
            const t = this._padding = di(ea(this.options) / 2), e = this.width = this.maxWidth - t.width,
        ...
        drawGrid() {
            ...
            if (e.pointLabels.display && function (t, e) {
                ...
                for (let n = e - 1; n >= 0; n--) {
                    const e = s.setContext(t.getPointLabelContext(n)), o = ui(e.font), {
                        x: a,
                        y: r,
                        textAlign: l,
                        left: h,
                    ...
                    if (!U(f)) {
                        const t = ci(e.borderRadius), s = di(e.backdropPadding);
                        i.fillStyle = f;
    ...
    class ba extends Ns {
        ...
        _generate() {
            const t = this._adapter, e = this.min, i = this.max, s = this.options, n = s.time,
                o = n.unit || ga(n.minUnit, e, i, this._getLabelCapacity(e)), a = Z(n.stepSize, 1),
                r = "week" === o && n.isoWeekday, l = Wt(r) || !0 === r, h = {};
            let c, d, u = e;
        ...
        _getLabelCapacity(t) {
            const e = this.options.time, i = e.displayFormats, s = i[e.unit] || i.millisecond,
                n = this._tickFormatFunction(t, 0, ma(this, [t], this._majorUnit), s), o = this._getLabelSize(n),
